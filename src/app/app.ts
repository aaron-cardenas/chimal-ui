...
export class App {
  ...
  constructor(private readonly seo: SeoService) {
    this.seo.setBasic(
      'CREDITARIA CHIMAL | Tu aliado financiero para auto, casa o negocio',
  ...
  slides: SlideData[] = [
    { id: 0, segment: 'general', collapsedTitle: 'CREDITARIA CHIMAL', title: 'Tu próximo auto, casa o negocio… más facil de lo que imaginas', subtitle: 'Nosotros comparamos por ti y te guiamos sin costo hasta la conseguir tu objetivo. Fácil, rápido y seguro.', imageUrl: '/oficina-3.webp', ctaText: 'Quiero mi asesoría gratis' },
